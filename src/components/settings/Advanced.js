...
class ExportLists extends Component {
  ...
  downloadTxtFile = (btn) => {
    ...
    const listData = new Blob(
      [this.getListData().join('\n')],
      { type: 'text/plain' }
    )
    ...
    return (
      ...
      <div className="p-grid">
        <div className="p-col-fixed">
          <span mode="basic" name="Import Nouns" url="./nouns" accept=".txt" auto/>
        </div>
        <div className="p-col-fixed">
          <span
            label="Export Nouns"
      ...
      <div className="p-grid">
        <div className="p-col-fixed">
          <span mode="basic" name="Import Adjectives" url="./adjectives" accept=".txt" auto/>
        </div>
        <div className="p-col">
          <span
