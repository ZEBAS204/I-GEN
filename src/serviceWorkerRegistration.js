...
export function register(config) {
	if (import.meta.PROD && 'serviceWorker' in navigator) {
		// The URL constructor is available in all browsers that support SW.
		const publicUrl = new URL(import.meta.BASE_URL, window.location.href)
		...
		window.addEventListener('load', () => {
			const swUrl = `${import.meta.BASE_URL}/service-worker.js`
